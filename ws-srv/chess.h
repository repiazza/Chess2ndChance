...
// KNIGHT
#define KNIGHT_INITIAL_MOVEMENT   MOVEMENT_DIRECTION_L
#define KNIGHT_MOVEMENT_RANGE     L_RANGE // 2 movements 4way expressed

// BISHOP
#define BISHOP_INITIAL_MOVEMENT   MOVEMENT_DIRECTION_DIAGONAL
#define BISHOP_MOVEMENT_RANGE     LINE_OF_SIGHT

// QUEEN
#define QUEEN_INITIAL_MOVEMENT    MOVEMENT_DIRECTION_COLUMN \
                                | MOVEMENT_DIRECTION_LINE \
                                | MOVEMENT_DIRECTION_DIAGONAL

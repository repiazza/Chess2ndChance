...
export const ALL_OPOSITE_EQUIVALENT = [
  [NORTH_EAST_DIRECTION][SOUTH_WEST_DIRECTION],
  [NORTH_WEST_DIRECTION][SOUTH_EAST_DIRECTION],
  [SOUTH_WEST_DIRECTION][NORTH_EAST_DIRECTION],
  [SOUTH_EAST_DIRECTION][NORTH_WEST_DIRECTION],
  [NORTH_DIRECTION][SOUTH_DIRECTION],
  [SOUTH_DIRECTION][NORTH_DIRECTION],
  [EAST_DIRECTION][WEST_DIRECTION],
  [WEST_DIRECTION][EAST_DIRECTION],
];

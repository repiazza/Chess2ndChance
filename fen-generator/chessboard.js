  ...
  window["ChessBoard"] =
    ...
    function (containerElOrId, cfg) {
      ...
      function checkDeps() {
        ...
        // ie: a single DOM node or jQuery object
          ...
          if (containerEl == null) containerEl = containerElOrId;
    ...
    */
      ...
      function animateSquareToSquare(src, dest, piece, completeFn) {
        ...
        var srcSquareEl = document.querySelector("[id=" + SQUARE_ELS_IDS[src] + "]");
        var srcSquarePosition = srcSquareEl.offset();
        var srcSquareEl = document.querySelector("[id=" + SQUARE_ELS_IDS[dest] + "]");
        var destSquarePosition = destSquareEl.offset();

        // create the animated piece and absolutely position it
        // over the source square
        var animatedPieceId = uuid();
        document.querySelector("[body]").append(buildPiece(piece, true, animatedPieceId));
        var animatedPieceEl = document.querySelector("[id=" + animatedPieceId + "]");
        animatedPieceEl.css({
          display: "",
          position: "absolute",
      ...
      function animateSparePieceToSquare(piece, dest, completeFn) {
        var srcOffset = document
          .querySelector("[id=" + SPARE_PIECE_ELS_IDS[piece] + "]")
          .offset();
        var destSquareEl = document.querySelector("[id=" + SQUARE_ELS_IDS[dest] + "]");
        var destOffset = destSquareEl.offset();

        // create the animate piece
        var pieceId = uuid();
        document.querySelector("[body]").append(buildPiece(piece, true, pieceId));
        var animatedPieceEl = document.querySelector("[id=" + pieceId + "]");
        animatedPieceEl.css({
          display: "",
          position: "absolute",
          left: srcOffset.left,
      ...
      function doAnimations(a, oldPos, newPos) {
        ...
        for (var i = 0; i < a.length; i++) {
          ...
          if (a[i].type === "clear") {
            document
              .querySelector("[id=" + SQUARE_ELS_IDS[a[i].square] + " ." + CSS.piece)
          ...
          if (a[i].type === "add" && cfg.sparePieces !== true) {
            document
              .querySelector("[id=" + SQUARE_ELS_IDS[a[i].square])
      ...
      function drawPositionInstant() {
        ...
        for (var i in CURRENT_POSITION) {
          ...
          document
            .querySelector("[id=" + SQUARE_ELS_IDS[i] + "]")
            .append(buildPiece(CURRENT_POSITION[i]));
        }
      }
      ...
      function removeSquareHighlights() {
        document
          .querySelector("[id=" + boardEl.id + "][class=" + CSS.square + "]")
          .classList.removeClass(CSS.highlight1 + " " + CSS.highlight2);
      }
      ...
      function snapbackDraggedPiece() {
        ...
        var sourceSquarePosition = document
          .querySelector("[id=" + SQUARE_ELS_IDS[DRAGGED_PIECE_SOURCE] + "]")
          .offset();
      ...
      function dropDraggedPieceOnSquare(square) {
        ...
        var targetSquarePosition = document
          .querySelector("[id=" + SQUARE_ELS_IDS[square] + "]")
          .offset();
      ...
      function beginDraggingPiece(source, piece, x, y) {
        ...
        if (source !== "spare") {
          ...
          document
            .querySelector("[id=" + SQUARE_ELS_IDS[source] + "]")
            .classList.addClass(CSS.highlight1);
          document.querySelector("[class=" + CSS.piece + "]").style = "display:none";
        }
      }
      ...
      function updateDraggedPiece(x, y) {
        ...
        if (validSquare(DRAGGED_PIECE_LOCATION) === true) {
          document
            .querySelector("[id=" + SQUARE_ELS_IDS[DRAGGED_PIECE_LOCATION] + "]")
        ...
        if (validSquare(location) === true) {
          document
            .querySelector("[id=" + SQUARE_ELS_IDS[location] + "]")
            .addClass(CSS.highlight2);
        }
    ...
    */
      ...
      function isMSIE() {
        return (
          navigator && navigator.userAgent && navigator.userAgent.search(/MSIE/) !== -1
        );
      }
      ...
      function initDom() {
        ...
        document.querySelector("[body]").append(buildPiece("wP", true, draggedPieceId));
        draggedPieceEl = document.querySelector("[id=" + draggedPieceId + "]");
